...
class GoogleModel(UnifiedModel):
    """
    ...
    def __init__(self, model_name: str, **kwargs):
        ...
        self._client = ChatGoogleGenerativeAI(model=model_name, **kwargs)
    ...
    def format_prompt(self, content_items: List[ContentItem]) -> List[Dict[str, Any]]:
        """
        Formats content items into Google-specific format.
        
        For Google models, this converts the content items into a list of message
